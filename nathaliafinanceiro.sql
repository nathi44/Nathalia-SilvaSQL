...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/02/2025 às 21:05
...
--
DROP DATABASE IF EXISTS `nathaliasilvaestoque`;
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `fk_codcliente` FOREIGN KEY (`cod_cliente`) REFERENCES `cliente` (`Cod_cliente`) ON DELETE CASCADE;
COMMIT;
